...
/**
 * LocationsMailsFixture
 */
class LocationsMailsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'mail_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'mail_id' => ['type' => 'index', 'columns' => ['mail_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['location_id', 'mail_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
