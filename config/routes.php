...
return static function (RouteBuilder $routes) {
    ...
    $routes->scope('/images', function (RouteBuilder $builder) {
        $builder->registerMiddleware('glide', new GlideMiddleware([
            ...
            'server' => [
                ...
                'driver' => \Cake\Core\Configure::read('GFX.driver'),
            ],
